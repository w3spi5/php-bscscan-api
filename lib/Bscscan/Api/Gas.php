...
class Gas extends AbstractApi
{
     ...
     * Returns the historical daily average gas limit of the Binance network.
     *
    ...
    /**
     * Get Binance Daily Total Gas Used
     * Returns the total amount of gas used daily for transctions on the Binance network.
     *
     * @param string $startdate the starting date in yyyy-MM-dd format, eg. 2019-02-01
     * @param string $enddate the ending date in yyyy-MM-dd format, eg. 2019-02-28
     * @param string $sort 'asc' or 'desc'
     ...
     * Returns the daily average gas price used on the Binance network.
     *
     * @param string $startdate the starting date in yyyy-MM-dd format, eg. 2019-02-01
     * @param string $enddate the ending date in yyyy-MM-dd format, eg. 2019-02-28
     * @param string $sort 'asc' or 'desc'
